...
class AIContentDetector:
    ...
    def _detect_locally(self, text, additional_features=None):
        ...
        try:
            ...
            features.extend([
                ...
                {'name': 'Sentence Variance', 'value': f"{variance:.2f}"}
            ])
            ...
            return self._format_result(0, 'Error', [{'name': 'Error', 'value': str(e)}])
    
    def _split_into_sentences(self, text):
        """Split text into sentences without NLTK dependency"""
    ...
    def _split_into_words(self, text):
        """Split text into words without NLTK dependency"""
