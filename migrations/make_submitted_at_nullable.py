...
with app.app_context():
    ...
    try:
        # Drop the NOT NULL constraint on submitted_at column
        # In SQLite, we need to recreate the table to modify column constraints
        ...
        conn.execute(db.text('INSERT INTO quiz_submission_new SELECT * FROM quiz_submission'))
        ...
        print('Successfully updated quiz_submission table - submitted_at column is now nullable')
